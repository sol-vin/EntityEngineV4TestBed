    ...
    public class ParticleTestState : TestBedState
    {
        ...
        public class ParticleTestManager : Entity
        {
            ...
            public class TestEmitter : Emitter
            {
                ...
                public TestEmitter(Entity e, string name, Texture2D texture, Vector2 tilesize, Body body)
                    : base(e, name, texture, tilesize, body)
                {
                }
                ...
                {
                    public TestParticle(EntityState stateref, IComponent parent, Emitter e)
                        : base(stateref, parent, 3000, e)
                    {
                        FadeAge = 1000;
                    }
                }
